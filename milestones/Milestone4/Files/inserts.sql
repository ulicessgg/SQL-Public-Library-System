...
-- patrons, libraries, and library branches STRONG
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Creation of Main County Libraries STRONG
-- -----------------------------------------------------
...
-- in this case Contra Costa	STRONG
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Specification of existing addresses for use to insert
-- in creating instituion records  WEAK
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Creation of patron accounts for patron use STRONG
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Specification of existing patrons for use to insert
-- e-cards full-service staff instituional and child
-- patron types WEAK
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Creation of items for checking out STRONG
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Specification of existing items for cataloging
-- and reference WEAK
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Creation of transactions for library procedures STRONG
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Specification of existing transactions for clerical
-- staff to manage and conduct reports on WEAK
-- -----------------------------------------------------
